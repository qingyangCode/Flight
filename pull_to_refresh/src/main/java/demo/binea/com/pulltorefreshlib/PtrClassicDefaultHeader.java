...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if(isAutoRefresh){
            mTitleTextView.setText(getResources().getString(R.string.str_syncing));
            return;
        }
        mTitleTextView.setVisibility(VISIBLE);
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.str_ptr_pull_down_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.str_ptr_pull_down));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(R.string.str_syncing);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.str_ptr_refresh_complete));
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.str_ptr_release_to_refresh);
        }
    }
